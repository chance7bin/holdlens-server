...
public final class MarketDetailResult {
    private MarketDetailResult() { }

    @Data @Builder @NoArgsConstructor @AllArgsConstructor
    public static class Task { private String serverTaskId; private String taskType; private String status; }
    @Data @Builder @NoArgsConstructor @AllArgsConstructor
    public static class FundNavHistory {
        private String fundCode; private String period; private String asOf; private List<FundNavPoint> points;
    }
    @Data @Builder @NoArgsConstructor @AllArgsConstructor
