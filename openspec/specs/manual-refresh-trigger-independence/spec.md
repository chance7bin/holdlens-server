# manual-refresh-trigger-independence Specification

## Purpose
TBD - created by archiving change decouple-manual-refresh-from-schedule-switches. Update Purpose after archive.
## Requirements
