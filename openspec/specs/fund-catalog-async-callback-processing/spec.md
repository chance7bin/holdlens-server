# fund-catalog-async-callback-processing Specification

## Purpose
TBD - created by archiving change async-fund-catalog-callback-processing. Update Purpose after archive.
## Requirements
